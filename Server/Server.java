...
//		------------------------Variables-------------------------
		...
		// Players
		InetAddress player1 = InetAddress.getByName("192.168.1.93");
		InetAddress player2 = InetAddress.getByName("192.168.1.92");
		botClass bot = new botClass();
		InetAddress activePlayer = InetAddress.getByName("0.0.0.0");
		// Gamelogic
